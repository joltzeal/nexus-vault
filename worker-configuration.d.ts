/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d2ae018ce3d898928341e76e9c7848e)
...
interface __BaseEnv_Env {
	...
	TELEGRAM_METADATA_API_URL: string;
	TELEGRAM_METADATA_API_TOKEN: string;
	TELEGRAM_MEDIA_MAX_BYTES: string;
	ALLOW_RESOURCE_MEDIA_UPLOAD: string;
	S3_UPLOAD_ENDPOINT: string;
	S3_UPLOAD_REGION: string;
	S3_UPLOAD_BUCKET: string;
	S3_UPLOAD_ACCESS_KEY_ID: string;
	S3_UPLOAD_SECRET_ACCESS_KEY: string;
	S3_MEDIA_PUBLIC_BASE_URL: string;
	S3_UPLOAD_FORCE_PATH_STYLE: string;
	TIKHUB_API_TOKEN: string;
	TURNSTILE_SITE_KEY?: "...";
	TURNSTILE_ALLOWED_HOSTNAMES?: "vault.example.com";
	BROWSERLESS_SCREENSHOT_ENDPOINT?: "https://...";
	AI_GATEWAY_ID?: "default";
	AI_SUMMARY_MODEL?: "@cf/meta/llama-3.1-8b-instruct-fp8";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_TRUSTED_ORIGINS" | "ALLOW_USER_REGISTRATION" | "BROWSERLESS_TOKEN" | "TELEGRAM_METADATA_API_URL" | "TELEGRAM_METADATA_API_TOKEN" | "TELEGRAM_MEDIA_MAX_BYTES" | "ALLOW_RESOURCE_MEDIA_UPLOAD" | "S3_UPLOAD_ENDPOINT" | "S3_UPLOAD_REGION" | "S3_UPLOAD_BUCKET" | "S3_UPLOAD_ACCESS_KEY_ID" | "S3_UPLOAD_SECRET_ACCESS_KEY" | "S3_MEDIA_PUBLIC_BASE_URL" | "S3_UPLOAD_FORCE_PATH_STYLE" | "TIKHUB_API_TOKEN" | "TURNSTILE_SITE_KEY" | "TURNSTILE_ALLOWED_HOSTNAMES" | "BROWSERLESS_SCREENSHOT_ENDPOINT" | "AI_GATEWAY_ID" | "AI_SUMMARY_MODEL">> {}
}
