...
const tagVariants = cva(
  [
    ...
    'inline-flex flex-nowrap items-center select-none whitespace-nowrap',
    'max-w-full min-w-0',
    'gap-[var(--andromeda-2)]',
...
type TagProps = HTMLAttributes<HTMLSpanElement> & {
  variant?: 'default' | 'accent' | 'warning' | 'fault';
  children?: ReactNode;
  onClose?: () => void;
};
...
export const Tag = forwardRef<HTMLSpanElement, TagProps>(function Tag(
  ...
  return (
    <span
      ...
      {...props}
    >
      <span className="inline-flex min-w-0 items-center gap-[var(--andromeda-1)] overflow-hidden text-ellipsis whitespace-nowrap [&>svg]:shrink-0">
        {children}
      </span>
      {onClose ? (
        <button
