/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ../../cloudflare-env.d.ts` (hash: c8dcd232af967f7d34715171939659f2)
...
interface __BaseEnv_CloudflareEnv {
	...
	WORKER_SELF_REFERENCE: Service<typeof import("./apps/frontend/worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/frontend/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "TWITTER_COOKIE_STRING" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "ALLOW_USER_REGISTRATION" | "BROWSERLESS_TOKEN">> {}
}
