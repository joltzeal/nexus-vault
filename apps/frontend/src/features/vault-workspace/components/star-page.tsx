              ...
              {resourceItems.map((item, index) => {
                ...
                return (
                  <ResourceCard
                    ...
                    commentBody={activeResourceId === item.sourceResourceId ? commentBody : ""}
                    comments={
                      commentsByResourceId[item.sourceResourceId] ?? resource.comments ?? []
                    }
                    disabled
                    index={index}
...
function toResource(item: StarredResourceItem): Resource {
  const metadata = parseResourceMetadataJson(item.metadataDataJson)
