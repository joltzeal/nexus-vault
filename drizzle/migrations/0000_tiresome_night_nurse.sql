...
CREATE TYPE "public"."resource_type" AS ENUM('magnet', 'twitter', 'telegram', 'douyin', 'wechat_mp', 'baidu_pan', 'pan_115', 'pan_123', 'quark_pan', 'uc_pan', 'xunlei_pan', 'pikpak', 'onedrive', 'google_drive', 'dropbox', 'alist', 'ftp', 'http', 'youtube', 'local_media', 'other');--> statement-breakpoint
...
CREATE UNIQUE INDEX "user_integration_settings_user_unique" ON "user_integration_settings" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "starred_resources_source_resource_idx" ON "starred_resources" USING btree ("source_resource_id");